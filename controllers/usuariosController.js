...
exports.validarRegistro = (req, res, next) => {
  ...
  req.checkBody("email", "El Email debe ser válido").notEmpty();
  req.checkBody("password", "El Password no puede ser vacío").notEmpty();
  req
    .checkBody("confirmar", "Confirmar Password no puede ser vacío")
    .notEmpty();
  req
